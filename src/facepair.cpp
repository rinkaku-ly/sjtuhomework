...
bool cal_intersection(EleFace *tria1, EleFace *tria2,vector<Vector3f*> &point) {
	...
	//fast judge separate
	if ((max(max(va1[0], vb1[0]) ,vc1[0]) < (min(min(va2[0], vb2[0]), vc2[0])) || (min(min(va1[0], vb1[0]), vc1[0])) > max(max(va2[0], vb2[0]), vc2[0]))) { return false; }
	if ((max(max(va1[1], vb1[1]), vc1[1]) < (min(min(va2[1], vb2[1]), vc2[1])) || (min(min(va1[1], vb1[1]), vc1[1])) > max(max(va2[1], vb2[1]), vc2[1]))) { return false; }
	if ((max(max(va1[2], vb1[2]), vc1[2]) < (min(min(va2[2], vb2[2]), vc2[2])) || (min(min(va1[2], vb1[2]), vc1[2])) > max(max(va2[2], vb2[2]), vc2[2]))) { return false; }
