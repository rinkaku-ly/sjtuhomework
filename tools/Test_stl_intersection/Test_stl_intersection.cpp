...
int main(int argc, char** argv)
{
	...
	StlFile stl_1 = slt_read("C:\\Users\\aaa\\source\\repos\\sjtuhomework3\\tools\\rabbit.stl");
	StlFile stl_2 = slt_read("C:\\Users\\aaa\\source\\repos\\sjtuhomework3\\tools\\yellowcat.stl");
	Octree root1(&stl_1, 5, 5);
	Octree root2(&stl_2, 5, 5);

	might_intersected_faces_list a_b(&root1, &root2);
	std::cout << a_b.intersectLine_list.size() << endl;
